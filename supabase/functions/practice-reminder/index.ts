...
const STUDENTS: Student[] = [
  {
    ...
    appName: "Word Summit",
    hero: "\u{1F436} Your doodle is waiting, Evia!",
    cta: "Keep climbing →",
    He: "She", his: "her",
    messages: [
      { subject: "Word Summit reminder \u{1F436}",
        intro: "Just a friendly nudge — no round yet today. Look how far you've climbed; don't stop now!" },
      { subject: "Your words miss you \u{1F9B4}",
        intro: "Today's practice hasn't happened yet. A single round only takes a few minutes — go earn some treats!" },
      { subject: "Quick round before bed? \u{1F415}",
        intro: "No practice recorded today — there's still time for one round. Your puppy is waiting!" },
      { subject: "Don't break the streak! \u{1F43E}",
        intro: "Today's round is still waiting for you. Keep those words fresh — one round and you're done for the day." },
      { subject: "Your doodle says: practice time \u{1F415}",
        intro: "You haven't practiced yet today. Hop on for a quick round — your doodle wants to grow!" },
    ],
    tiles: (state) => [
      { v: typeof state.acorns === "number" ? state.acorns as number : 0, l: "treats" },
